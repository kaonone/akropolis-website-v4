    ...
    whatYouCanBuild: {
      ...
      items: {
        ...
        alternativeIdentity: {
          ...
          description: 'Community voting works as a collateral.\n' + 'Credit Union members act as guarantors.',
        },
        bank: {
