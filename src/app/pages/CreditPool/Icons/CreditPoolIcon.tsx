...
export function CreditPoolIcon(props: GetProps<typeof SvgIcon>) {
  ...
  return (
    <SvgIcon {...props} classes={classes} viewBox="0 0 96 66">
      <defs>
        <linearGradient id="CreditPoolIcon-gradient" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#422C66" />
          <stop offset="100%" stopColor="#1D134A" />
        </linearGradient>
      </defs>
      <g fill="url(#CreditPoolIcon-gradient)" fillRule="evenodd">
        <path
